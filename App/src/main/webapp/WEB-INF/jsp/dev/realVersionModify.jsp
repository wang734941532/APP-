                      ...
                      %>
                       ...
                       <tr>
                          ...
                          <td>${version.modifydate } </td>
                           <td><a href="${pageContext.request.contextPath }/dev/realmodifyVersion?id=${version.id }&appId=${version.appid}">修改</a></td>
                        </tr>
  ...
  <input type="hidden" name="engname" value="${info.apkname}" />
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="versionNo" required="required"  value="${version.versionno }" class="form-control col-md-7 col-xs-12" name="versionNo" />
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        	<textarea  class="form-control" name="versionInfo"  value="${version.versioninfo }" rows="3" placeholder="简介"></textarea>
                        </div>
                      </div>
                       <div class="form-group">
                        <label for="apkName" class="control-label col-md-3 col-sm-3 col-xs-12">apk文件<span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="apkName" class="form-control col-md-7 col-xs-12"   value="${version.apkfilename }" type="file" name="apkName" />
                        </div>
                      </div>
